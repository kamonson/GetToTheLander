...
bool SplashScene::init()
{
	...
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadBackgroundMusic("sounds/BKGMusic.mp3");
...
//Function to go to main menu after TRANSITION_TIME time using TransionFade
